...
## for testing all data splits are replaced with sample train data
SAVE_DATASET_IMAGES_FILENAME = 'X_train.npy'
SAVE_DATASET_LABELS_FILENAME = 'Y_train.npy'
SAVE_DATASET_IMAGES_VALID_FILENAME = 'X_train.npy'
SAVE_DATASET_LABELS_VALID_FILENAME = 'Y_train.npy'
SAVE_DATASET_IMAGES_TEST_FILENAME = 'X_train.npy'
SAVE_DATASET_LABELS_TEST_FILENAME = 'Y_train.npy'
